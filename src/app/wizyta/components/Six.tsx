          ...
          <div className={`${styles.bottomSection} flex  items-center`}>
            <div className="Inner flex items-center"> 
                ...
                <div className={`${styles.text} flex flex-col gap-3`}>
                    ...
                    <div>
  <p className={` `}>Podczas wideorozmowy zbieram wywiad i ustalam jak pomóc dziecku oraz dobieram odpowiednią terapię i ćwiczenia dla rodzica.</p>
  <p className={`font-bold `}>
    <b>Nauczę Cię prawidłowego sposobu noszenia oraz pielęgnacji dziecka. </b>
  </p>
  <p className={` `}>Nie jest to typowa wizyta, gdzie fizjoterapeuta ćwiczy, a Ty się przyglądasz. Celem konsultacji online jest nauczyć Cię ćwiczeń tak, byś to Ty rodzicu wziął odpowiedzialność za swoje dziecko.</p>
  <p className={`font-bold `}>
    <span>Wystarczy nam jedna wizyta, by wybrać odpowiednie ćwiczenia dla dziecka. Ustalamy cele, a gdy je osiągniesz, umawiamy kolejną wizytę.</span>
  </p>
</div>
                    </div>
