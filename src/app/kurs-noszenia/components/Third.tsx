          ...
          <div className={`${styles.bottomSection} flex  items-center`}>
            <div className="Inner flex items-center"> 
                ...
                <div className={`${styles.text} flex flex-col gap-3`}>
                    ...
                    <ul><li><p>Kiedy noszenie dziecka przodem do świata jest wskazane?</p></li><li><p>Jak nosić, jeśli dziecko nie lubi fasolki?</p></li><li><p>Jak podnieść dziecko do odbicia?</p></li><li><p>Jak podnieść dziecko z łóżeczka?</p></li><li><p>Jak obracać noworodka?</p></li></ul>

                    <p>To najczęstsze pytania, jakie dostaję na konsultacjach. W kursie pokażę Ci, jak nosić dziecko, by było to dla niego bezpiecznie.</p>
                    </div>
