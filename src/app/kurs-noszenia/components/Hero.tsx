          ...
          <div className={`${styles.bottomSection} flex  items-center`}>
            <div className="Inner flex items-center"> 
                ...
                <h2>Noszenie i pielęgnacja maluszka</h2>
                    ...
                    <p>Pigułka wiedzy medycznej i doświadczenia pracy z małymi pacjentami. Nauczysz się, jak dbać o twoje maleństwo bez stresu i wychodzenia z domu.</p>
                    </div>
                    <div className={`flex gap-7`}>
                    <div className={`${styles.button}`}>
                    <Link href="/filmy-i-ebooki/asymetria-ulozeniowa">
                        <button className="secondaryButton">Czytaj więcej</button></Link>
                   </div>

                    <div className={`${styles.button}`}>
                    <Link href="/filmy-i-ebooki/asymetria-ulozeniowa">
                        <button className="Button_button__6pObN">Zobacz ofertę</button></Link>
                   </div>
                   </div>
          </div>
        </div>
