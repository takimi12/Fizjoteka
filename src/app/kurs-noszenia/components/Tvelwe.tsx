...
const Tvelwe = () => {
  return (
    ...
    <div className={` Container`}>
        ...
        <h6 className={` mt-10 mb-10`} >Kurs przygotowałam na podstawie najczęstszych pytań, jakie dostaję podczas konsultacji. Aby uzyskać odpowiedzi na nie wszystkie, potrzebowalibyśmy minimum 5 wizyt! A w tym kursie otrzymujesz to w cenie jednej wizyty z fizjoterapeutą.</h6>
        </div>
