              ...
              <div className={`${styles.image} flex justify-center`}>
                ...
                <div className={`${styles.text} flex flex-col gap-3`}>
                  <h6>Jestem fizjoterapeutką dziecięcą i edukatorką.</h6>
                    <p>Ukończyłam Collegium Medicum Uniwersytetu Jagiellońskiego w Krakowie. Aktualnie pracuję w Krakowie i w Warszawie.</p>
                    <p>Na co dzień zajmuję się rehabilitacją najmłodszych pacjentów oraz wspieraniem ich rodziców.</p>
                    <p>Swoją wiedzą i doświadczeniem dzielę się na blogu, w kursach online, e-bookach oraz na webinarach. Sprawiam, że fizjoterapia jest dostępna dla każdego.</p>
                    </div>
