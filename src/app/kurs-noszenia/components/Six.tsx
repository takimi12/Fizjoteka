          ...
          <div className={`${styles.bottomSection} flex  items-center`}>
            <div className="Inner flex items-center"> 
                ...
                <div className={`${styles.text} flex flex-col gap-3`}>
                    ...
                    <p>Prawidłowy sposób podnoszenia to taki, w którym maluszek wykaże aktywność, dzięki czemu część pracy wykona za nas.</p>
                    <p>Podnoszenie noworodka różni się od podnoszenia dziecka, które kontroluje już główkę.</p>
                    <p>
                    W kursie pokazuję, jak podnieść nowo narodzone dziecko oraz to nieco starsze. </p>
                    </div>
