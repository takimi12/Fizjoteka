          ...
          <div className={`${styles.bottomSection} flex  items-center`}>
            <div className="Inner flex items-center"> 
                ...
                <div className={`${styles.text} flex flex-col gap-3`}>
                    <p>Asymetria ułożeniowa to jedno z najczęstszych schorzeń u niemowląt. Rodzice często jednak nie wiedzą dużo na jej temat.</p>
                    <p>Jeśli Ty masz wątpliwości, czy Twoje dziecko może mieć asymetrię sprawdź koniecznie mój FizQuiz.</p>
                    </div>
                    <div className={`${styles.button}`}>
                    <Link href="/filmy-i-ebooki/asymetria-ulozeniowa">
                        <button className="Button_button__6pObN">przejdź quiz</button></Link>
       </div>
          </div>
        </div>
